...
import com.example.Pentlux_Restaurant_System.dao.BillDao;
...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        try {
            ...
            if(this.validateRequestMap(requestMap)){
                ...
                String data = "Name: " + requestMap.get("name") + "\nMobile Number: " + requestMap.get("mobileNumber") +
                ...
                for(int i = 0; i<jsonArray.length(); i++){
                    this.addRows(table, RestaurantUtils.getMapFromJson(jsonArray.getString(i)));
                }
                document.add(table);
            ...
            } else return RestaurantUtils.getResponseEntity("Required data not found", HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<List<Bill>> getBills() {
        ...
        try {
            if(jwtFilter.isAdmin()){
                ...
                bills = billDao.getBillByUsername(jwtFilter.getCurrentUsername());
            }
        } catch (Exception exception){
            exception.printStackTrace();
        }
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try {
            ...
            if(billOptional.isPresent()){
                ...
                return RestaurantUtils.getResponseEntity("Bill "+billOptional.get().getUuid() + " was deleted successfully", HttpStatus.OK);
            } else return RestaurantUtils.getResponseEntity("Bill with id " + id + " does not exists", HttpStatus.NOT_FOUND);
        } catch (Exception exception){
            exception.printStackTrace();
        }
        return RestaurantUtils.getResponseEntity(RestaurantConstants.SOMETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try {
            ...
            bill.setMobileNumber((String) requestMap.get("mobileNumber"));
